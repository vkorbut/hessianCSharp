...
namespace hessiancsharp.client.hessian2
{
	/// <summary>
	...
	public class CHessianMethodCaller
	{
        ...
        private WebProxy m_proxy; // null = system default
        ...
        private byte[] GetRequestBytes(object[] arrMethodArgs, MethodInfo methodInfo)
        {
            ...
            Hessian2Output cHessianOutput = this.GetHessianOutput(memoryStream);
		...
		private Hessian2Output GetHessianOutput(Stream stream) 
		{
			Hessian2Output cHessianOut = new Hessian2Output(stream);
			return cHessianOut;
		}
