...
namespace hessiancsharp.io.hessian2
{
    ...
    public abstract class AbstractHessianOutput : CHessianProtocolConstants
    {
        ...
        public abstract void Call(string method, object[] args);
        ...
        public abstract int WriteObjectBegin(string type);
        public abstract void WriteClassFieldLength(int len);
        public abstract void WriteObjectEnd();
        public abstract void WriteByteBufferStart();
        public abstract void WriteByteStream(Stream @is);
        ...
        private CSerializerFactory _serializerFactory;
